...
@section('content')
    <div class="container">
        <div class="row">
            <h1>出品登録フォーム</h1>
            <form action="{{url('/register/confirm')}}" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    <label for="InputItemDetail">商品説明</label><br>
				...
				<span class="btn btn-primary">
					全体画像 <input type="file" name="main_image" style="display:none" >
				</span>
				...
				<span class="btn btn-primary">
					セット１<input type="file" style="display:none" name="image1" class="uploadFile">
				</span>
                    </label>
                    <input type="text" class="form-control"  readonly=""><br>
				...
				<span class="btn btn-primary">
					セット２<input type="file" name="image2" style="display:none" class="uploadFile">
				</span>
                    </label>
                    <input type="text" class="form-control" readonly=""><br>
				...
				<span class="btn btn-primary">
					セット３<input type="file" style="display:none" name="image3" class="uploadFile">
				</span>
                    </label>
                    <input type="text" class="form-control"  readonly=""><br>
